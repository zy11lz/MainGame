...
module cfg
{
	export class ActivityAchieveRoadCfgData extends cfg.ActivityAchieveRoadBaseCfgData
	{
		constructor()
		{
			super();
		...
		// 成就列表 key: 活动id_天数_分组
		private static _dataAchieveDic: { [key: string]: ActivityAchieveRoadCfgInfo[] } = {};

		/** 一个活动ID对应一个列表 */
		protected static _dataArrByActivityId: Object;
		public static getDataArrayByActivityId(value: number): ActivityAchieveRoadCfgInfo[]
		{
  ...
  */
		public static getAchieveList(act_id: number, day: number, group: number): ActivityAchieveRoadCfgInfo[]
		{
