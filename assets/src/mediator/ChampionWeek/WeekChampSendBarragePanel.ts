module Pro
{
    ...
    * @author jason.xu
    */
    export class WeekChampSendBarragePanel extends ProUI.WeekChampion.WeekChampionSendBarrageUI
    {
        ...
        private init()
        {
            ...
            //价格
            let needItemArr = cfg.WeekChampionConstInfoCfgData.getFirstInfo().danmuNeedItem.split("_");
        ...
        private onClickSend(): void
        {
            ...
            this.txtInput.text = "";
            WeekChampionSend.sendDanmuAsk(msg);
            EventMgr.trigger(EventNotify.WeekChampion_AddSelfBarrage, msg);
            this.closeUI();
        }
        ...
        private onClickComboProveince(): void
        {
            ...
            this.listCombo.onRefresh(list.length, this, (btn: component.UIButton, index: number) =>
            {
                ...
                btn.onClick(this, () =>
                {
                    ...
                    WeekChampionSend.sendDanmuAsk(cfgLb);
                    EventMgr.trigger(EventNotify.WeekChampion_AddSelfBarrage, cfgLb);
                    this.closeUI();
