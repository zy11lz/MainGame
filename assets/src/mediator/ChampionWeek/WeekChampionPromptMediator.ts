module Pro
{
    ...
    * 
    */
    export class WeekChampionPromptMediator extends BaseMediator implements IMediator
    {
        public UIPanel: ProUI.WeekChampion.WeekChampionPromptUI;
        ...
        public openUI(): void
        {
            this.showPanel(ProUI.WeekChampion.WeekChampionPromptUI, 1);
        }
        ...
        {
            //初始化奖励预览列表
            let addItems = cfg.WeekChampionConstInfoCfgData.getAddItemAryByInfo();
