module Pro
{
    ...
    * @author jason.xu
    */
    export class WeekChampGuessPanel extends ProUI.WeekChampion.WeekChampionGuessPanelUI
    {
        /** 赔率 */
        ...
        private onClickConfirm(): void
        {
            ...
            WeekChampionSend.guessAsk(this._isLeft, value);
            this.closeUI();
        }
        ...
        public setGuessData(nickname: string, isLeft: boolean, losePercent: number)
        {
            ...
            let ownCount = WeekChampionDataMgr.guessCoin;
