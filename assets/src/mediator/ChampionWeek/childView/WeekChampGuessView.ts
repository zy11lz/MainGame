module Pro
{
    ...
    * 
    */
    export class WeekChampGuessView extends ProUI.WeekChampion.ChildView.GuessViewUI
    {
        /** 赔率百分百进度条显示的赔率值范围 */
        ...
        private init()
        {
            this._percentLimit[0] = cfg.WeekChampionConstInfoCfgData.getFirstInfo().minOdds / 100;
            this._percentLimit[1] = cfg.WeekChampionConstInfoCfgData.getFirstInfo().maxOdds / 100;
        }
        ...
        private addDataEvent(): void
        {
            ...
            EventMgr.on(CmdEvent.WeekChampion_SysGuessAck, this, this.onSysGuessAck);
            /** 竞猜币数量有变化 */
            EventMgr.on(EventNotify.WeekChampion_GuessCoin_Change, this, this.onChangeGuessCoin);
        }
        ...
        private removeDataEvent(): void
        {
            ...
            //竞猜下注同步返回	PBG2CChampionSynGuessAck
            EventMgr.off(CmdEvent.WeekChampion_SysGuessAck, this, this.onSysGuessAck);
            /** 竞猜币数量有变化 */
            EventMgr.off(EventNotify.WeekChampion_GuessCoin_Change, this, this.onChangeGuessCoin);
        }
        ...
        {
            if (WeekChampionDataMgr.state != Pb_God._emChampionState._emChampionState_Guess)
            {
                TipsUtils.showTipsByLanId("champ_msg19");
                return;
            }
            let panel = new WeekChampGuessPanel();
        ...
        public hideGuess(): void
        {
            this.MyGuess.visible = false;
        }
        ...
        public setGuessAck(value: Pb_God.PBG2CChampionQueryGuessAck): void
        {
            ...
            // 没有对战数据时显示倒计时
            EventMgr.trigger(EventNotify.WeekChampion_ShowTimeView,value.battle ? true : false);
            ...
            this.txtLeftNickname.text = this._leftNickname = Global.getLangStr("complain_msg8",value.battle.leftbattle.playerdisplay.worldid,value.battle.leftbattle.playerdisplay.playername);
            this.txtRightNickname.text = this._rightNickname =Global.getLangStr("complain_msg8",value.battle.rightbattle.playerdisplay.worldid,value.battle.rightbattle.playerdisplay.playername);
            this._leftPlayerId = value.battle.leftbattle.playerdisplay.playerid;
        }

        private refreshView(): void
        {
            this.txtJettonCount.text = WeekChampionDataMgr.guessCoin + "";
