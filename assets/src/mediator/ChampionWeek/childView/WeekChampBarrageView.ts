module Pro
{
    ...
    * @author jason.xu
    */
    export class WeekChampBarrageView extends ProUI.WeekChampion.ChildView.BarrageViewUI
    {
        //缓存弹幕数据
        ...
        {
            let sendView = new WeekChampSendBarragePanel();
        ...
        private addDataEvent(): void
        {
            ...
            EventMgr.on(CmdEvent.WeekChampion_QueryDanmuAck, this, this.onQueryDanmuAck);
            EventMgr.on(EventNotify.WeekChampion_AddSelfBarrage, this, this.onAddSelfBarrage);

        }

        private removeDataEvent(): void
        {
            EventMgr.off(CmdEvent.WeekChampion_QueryDanmuAck, this, this.onQueryDanmuAck);
            EventMgr.off(EventNotify.WeekChampion_AddSelfBarrage, this, this.onAddSelfBarrage);
        }
        ...
        private pullData(): void
        {
            ...
            WeekChampionSend.queryDanmuAsk(this._curIndex, this._singlePullCount);
        }
