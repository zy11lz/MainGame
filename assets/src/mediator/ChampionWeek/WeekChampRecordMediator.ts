module Pro
{
    ...
    * @author jason.xu
    */
    export class WeekChampRecordMediator extends BaseMediator implements IMediator
    {
        public UIPanel: ProUI.WeekChampion.WeekChampionRecordUI;
        ...
        public openUI(): void
        {
            this.showPanel(ProUI.WeekChampion.WeekChampionRecordUI, 1);
        }
        ...
        protected setRecord(value: Pb_God.PBChampionFightRecord): void
        {
            ...
            this.UIPanel.listView.onRefresh(list.length, this, (tempUI: ProUI.Champion.ListItems.RecordItemViewUI, index: number) =>
            {
                ...
                {
                    VideoSend.playSystem(Pb_God._emVideoType.VideoType_WeekChampion, data.battlesn, 0);
                });
