module Pro
{
    ...
    * @author jason.xu
    */
    export class WeekChampionMyGuessMediator extends BaseMediator implements IMediator
    {
        public UIPanel: ProUI.WeekChampion.WeekChampionMyGuessUI;
        ...
        public openUI(): void
        {
            this.showPanel(ProUI.WeekChampion.WeekChampionMyGuessUI, 1);
        }
        ...
        public initUI(): void
        {
            ...
            WeekChampionSend.guessRecordAsk();
        }
        ...
        public addEvent(): void
        {
            ...
            //data event 
            this.addEventMgr(CmdEvent.WeekChampion_GuessRecordAck, this, this.onGuessRecordAck);
        }
        ...
        protected onGuessRecordAck(value: Pb_God.PBChampionGuessRecord): void
        {
            ...
            let hasRecordingNum = hasRecording ? 1 : 0;
            //如果有当前正在进行中的竞猜，则在第一个显示， 否则按列表正常显示
            this.UIPanel.listView.onRefresh(list.length + hasRecordingNum, this, (tempUI: ProUI.Champion.ListItems.MyGuessListItemUI, index: number) =>
            {
                //有正在竞猜的
                if (index == 0 && hasRecording)
                {
                    ...
                    tempUI.txtRound.text = cfg.WeekChampionRoundCfgData.getNameByRoundID(data.round || WeekChampionDataMgr.round);
                ...
                } else
                {
                    ...
                    tempUI.txtRound.text = cfg.WeekChampionRoundCfgData.getNameByRoundID(recordData.round || 1);
                    ...
                    {
                        VideoSend.playSystem(Pb_God._emVideoType.VideoType_WeekChampion, recordData.battlesn, recordData.windisplay.playerid);
                    });
                }
            });
        }
