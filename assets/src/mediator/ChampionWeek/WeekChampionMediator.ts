module Pro
{
    ...
    * @author jason.xu
    */
    export class WeekChampionMediator extends BaseMediator implements IMediator
    {
        public UIPanel: ProUI.WeekChampion.WeekChampionUI;
        ...
        public openUI(): void
        {
            this.showPanel(ProUI.WeekChampion.WeekChampionUI, 1);
        }
        ...
        public closeUI(): void
        {
            ...
            this.UIPanel.viewFinal64.cleanUp(); //32强分布图
        ...
        public initUI(): void
        {
            ...
            this.UIPanel.tabGrp.onClick(this, this.onClickTab,
                ...
                new component.UITabData("champ_tab3_2"), new component.UITabData("champ_tab4")],
                [new component.UITabStyle("#f13b54"), new component.UITabStyle("#fffced")]
            );

            WeekChampionSend.openAsk();
            WeekChampionDataMgr.reddotModel.setRedDot(0);
        ...
        */
        ...
        public addEvent(): void
        {
            ...
            this.addEventMgr(CmdEvent.WeekChampion_SelfGuessAck, this, this.onSelfBattleInfoAck)
            //查询竞猜返回		PBG2CChampionQueryGuessAck
            this.addEventMgr(CmdEvent.WeekChampion_QueryGuessAck, this, this.onQueryGuessAck);
            //查看对战信息		PBChampionBattle
            this.addEventMgr(CmdEvent.WeekChampion_QueryBattleInfo, this, this.onQueryBattleInfo);

            //client data event
            //状态变化
            this.addEventMgr(EventNotify.WeekChampion_StateChange, this, this.onChangeState);
            this.addEventMgr(EventNotify.WeekChampion_ShowFightInfo, this, this.onShowFightInfo);
            this.addEventMgr(EventNotify.WeekChampion_ShowTimeView, this, this.onShowTimeView);
        ...
        {
            let strHelp = Global.getLangStr("weekChampionTips");
            UIManager.Inst.forceOpen(new BaseOpenUIData(PanelNotify.Open_Help, strHelp));
        }
        //竞技商店
        private onClickShop(): void
        {
            UIManager.Inst.forceOpen(new BaseOpenUIData(PanelNotify.Open_Shop, Pb_God._emShopType.ShopType_WeekChampion), BaseBackUIType.HideBackUI);
        }
        ...
        {
            WeekChampionSend.fightRecordAsk();
        }

        /** 点击奖励 */
        private onClickReward(): void
        {
            UIManager.Inst.forceOpen(new BaseOpenUIData(PanelNotify.Open_WeekChampReward));
        }
        ...
        private shiftTabPage(tabIndex: number): void
        {
            ...
            this.UIPanel.viewFighting.hide();  //战斗阵容视图， 分别在我的竞赛、竞猜、和64强赛分页都有可能需要显示
            this.UIPanel.viewFinal64.hide(); //64强分布图
        ...
        {
            // if (WeekChampionDataMgr.state == Pb_God._emChampionState._emChampionState_Match)
            // {
            ...
            WeekChampionSend.queryGuessAsk(); //查询竞猜
            // this.UIPanel.timeView.show();
            // this.UIPanel.viewBarrage.show();  //弹幕
        }
        ...
        private toFinal32PageView(): void
        {
            ...
            if(WeekChampionDataMgr.round > Pb_God._emWeekChampionRound._emWeekChampionRound_TOP8)
            {
                this.UIPanel.viewFinal64.show8();
            }
            else
            {
                this.UIPanel.viewFinal64.show64();
            }
            // this.UIPanel.timeView.show();
            // this.UIPanel.viewBarrage.show();  //弹幕
        ...
        private onShowFightInfo(leftPlayerId: number, rightPlayerId: number, round: number): void
        {
            ...
            this.UIPanel.viewFinal64.hide();
            this.UIPanel.viewFighting.show();

            //向服务器发送查看请求。
            WeekChampionSend.queryBattleInfo(round, leftPlayerId, rightPlayerId);
        }

        /** 重新布阵 */
        private onSaveEmbattle(embattleType: number): void
        {
            if (embattleType != Pb_God._emZhenfaType.ZhenfaType_WeekChampion) return;
            if (!WeekChampionDataMgr.isOpening) return;
        ...
        protected onSelfBattleInfoAck(value: Pb_God.PBG2CChampionSelfGuessAck): void
        {
            ...
            if (WeekChampionDataMgr.isTakePartIn)
            {
                this.UIPanel.viewFighting.show();
                this.UIPanel.viewFighting.setFightInfo(value.battle,this.UIPanel.tabGrp.tabIndex);
                this.UIPanel.timeView.show();
            } else
            {
                this.UIPanel.boxNoOpenView.show();
         ...
         * 显示倒计时页面
         */
        private onShowTimeView(isShow: boolean = false): void
        {
            this.UIPanel.timeView.showTab(this.UIPanel.tabGrp.tabIndex);
            if(!isShow)
            {
                this.UIPanel.viewFighting.hide();
                this.UIPanel.viewFinal64.hide(); //64强分布图
                this.UIPanel.viewGuess.hideGuess();  //竞猜下注图
                // this.UIPanel.timeView.show();
                this.UIPanel.viewBarrage.show();
            }
            else
            {
                // this.UIPanel.timeView.hide();
                this.UIPanel.viewBarrage.hide();
            }
        ...
        protected onQueryBattleInfo(value: Pb_God.PBChampionBattle): void
        {
            ...
            this.UIPanel.viewFighting.setFightInfo(value,this.UIPanel.tabGrp.tabIndex);
        }
        ...
        private onClickReturn(): void
        {
            ...
            UIManager.Inst.forceOpen(new BaseOpenUIData(PanelNotify.Open_WeekChampionArenaTop3, 1), BaseBackUIType.CloseQuene);
        }
    }
}