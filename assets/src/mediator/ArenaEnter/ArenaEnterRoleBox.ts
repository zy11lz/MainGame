module Pro
{
    ...
    * 
    */
    export class ArenaEnterRoleBox extends ProUI.Challenge.ArenaEnterRoleBoxUI
    {
        ...
        {
            ChallengeSend.like(this.bindPlayerId);
        }
        ...
        public setRoleData(page: number, playerdisplay: Pb_God.PBPlayerDisplay, index: number): void
        {
            ...
            } else
            {
                ...
                if (page == 1)
                { //冠军赛才需要显resetRes
                    Global.setResShapeTitle(this.imgTitle, cfg.ChampionTopPrizeCfgData.getAddTitleByRank(this.index + 1));
                }
