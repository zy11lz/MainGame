module Pro
{
    ...
    * @author jason.xu
    */
    export class ChampionTop3Mediator extends BaseMediator implements IMediator
    {
        public UIPanel: ProUI.Champion.ChampionTop3UI;
        ...
        public openUI(): void
        {
            this.showPanel(ProUI.Champion.ChampionTop3UI, 1, BaseAddLayer.TopUI, true);
        }
