module Pro
{
    ...
    * 
    */
    export class ChampionResultMediator extends BaseMediator implements IMediator
    {
        public UIPanel: ProUI.Champion.ChampionResultUI;
        ...
        public openUI(): void
        {
            this.showPanel(ProUI.Champion.ChampionResultUI, 1, BaseAddLayer.TopUI, true, 1);
        }
