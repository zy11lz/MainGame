module Pro {
    ...
    * 
    */
    export class ChampRankView extends ProUI.Champion.ChildView.RankViewUI  {

        /** 排行榜类型 */
        private _rankType = Pb_God._emTopListType.TopListType_Champion;
		 ...
		 * 		likeNum			uint32	次数
		 */
        protected onLikeNum(value: Pb_God.PBChallengeLikeAck): void  { //冠军赛与竞技场共用同一份点赞数据
            //找到对应的一条，然后刷新即可
