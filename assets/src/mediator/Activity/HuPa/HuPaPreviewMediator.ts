module Pro
{
    export class HuPaPreviewMediator extends BaseMediator implements IMediator
    {
        ...
        public initialization(): void
        {
            this.UIPanel.FunBox.initData(this.UIPanel.tabGrp, [
                new TableBarContinerData("hero_hupa_tab1", "story", HuPaStoryLayer),
                new TableBarContinerData("hero_hupa_tab2", "upgrade1", HeroDetailUpgradeTabel),
                new TableBarContinerData("hero_hupa_tab3", "upgrade2", HeroDetailUpgradeTabel),
        ...
        private onFunBoxClick(index: number, tabName: string)
        {
            if (index == 1 || index == 2)
            {
                let id = index == 1 ? CfgID.PetID.HuPa : CfgID.PetID.HuPaLiberate;
        ...
        private heroItemSelected()
        {
            ...
            let id = this.UIPanel.tabGrp.tabIndex <= 1 ? CfgID.PetID.HuPa : CfgID.PetID.HuPaLiberate;
            let info = cfg.PetBookCfgData.getBookHeroById(id);
