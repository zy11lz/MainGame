module Pro
{
     ...
     * 限时兑换商店物品
     */
    export class ExchangeShopPageItem extends ProUI.ActivityMain.ExChangeShop.ExchangeShopItemUI
    {
        ...
        public setItemByActShopCfg(act_cfg: cfg.ActivityCfgInfo, exchangeCfg: cfg.ActivityExchangeCfgInfo): void
        {
            ...
            // 已售完
            this.imgFullBack.visible = this.imgFullLimt.visible = max_count > 0 && (sold_count >= max_count);

            // 价格
            this.txtCurrencyCount.text = this._exchangeCfg.needAmount.toString();

            this.htmlTxtLimit.showText = max_count > 0 ? Global.getLangStr("common_buyLimit2", sold_count, max_count) : "";
        ...
        private onClickHandler(btn: component.UIButton)
        {
            ...
            openUIData.limitBuyCount = this._exchangeCfg.limitNum == 0 ? -1 : this._exchangeCfg.limitNum;
            ...
            openUIData.maxCount = can_buy_count;
