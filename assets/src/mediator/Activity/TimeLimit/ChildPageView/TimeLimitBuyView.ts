...
{
    /**
     * 通用活动TimeLimitActivityMediator 分页类型1 ： 限时礼包购买（比如必买礼包）
     * @author jason.xu
     */
    export class TimeLimitBuyView extends ProUI.ActivityMain.TimeLimit.PageView.BuyGiftsUI implements ITableView
    {
        ...
        private refreshItemByShopInfo(itemUI: ProUI.ActivityMain.TimeLimit.PageItemView.BuyGiftsListItemUI, shopCfgInfo: cfg.ShopFixShopCfgInfo): void
        {
            ...
            itemUI.img_outOfPiont.visible = false;
        ...
        private refreshItemByChargeInfo(itemUI: ProUI.ActivityMain.TimeLimit.PageItemView.BuyGiftsListItemUI, chargeCfgInfo: cfg.ChargeCfgInfo): void
        {
            ...
            itemUI.img_outOfPiont.visible = chargeCfgInfo.outOfPrint == 1 ? true : false;
        ...
        private onTimer(): void
        {
            ...
            this.txt_time.showText = Global.getLangStr("activity_msg5", Global.GetRemindTime(tmpPassTime, 9));
        }
    }
}