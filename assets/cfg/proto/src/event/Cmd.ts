...
module Pro.Cmd
{
	...
	/**领取问卷奖励 PBU32	*/
	export var C2S_Common_SurveyPrize: CmdType = createCmd("C2S_Common_SurveyPrize", 1, 23, true, Pb_God.PBU32);
	/**开启系统奖励 PBU32*/
	...
	export var S2C_Faction_UpgradePVPSkill: CmdType = createCmd("S2C_Faction_UpgradePVPSkill", 10, 34, false, Pb_God.PBG2CFactionPVPSkillUpgrade);
	/**	 PVP技能重置				PBG2CFactionPVPSkillReset*/
	export var S2C_Faction_PVPSkillReset: CmdType = createCmd("S2C_Faction_PVPSkillReset", 10, 35, false, Pb_God.PBG2CFactionPVPSkillReset);
	...
	/**	 PVP技能升级				PBU32*/
	export var C2S_Faction_UpgradePVPSkill: CmdType = createCmd("C2S_Faction_UpgradePVPSkill", 10, 28, true, Pb_God.PBU32);
	/**	 PVP技能重置				PBU32*/
	export var C2S_Faction_PVPSkillReset: CmdType = createCmd("C2S_Faction_PVPSkillReset", 10, 29, true, Pb_God.PBU32);
	/**	 查询所有对阵列表		*/
	...
	/**请求地址  无内容*/
	export var C2S_Order_AddrData: CmdType = createCmd("C2S_Order_AddrData", 52, 1, true);
	/**增加地址	PBAddrInfo*/
	export var C2S_Order_NewAddr: CmdType = createCmd("C2S_Order_NewAddr", 52, 2, true, Pb_God.PBAddrInfo);
	/**修改地址	PBAddrInfo*/
	export var C2S_Order_ChangeAddr: CmdType = createCmd("C2S_Order_ChangeAddr", 52, 3, true, Pb_God.PBAddrInfo);
	/**请求订单信息，参数订单类型 PBU32 */
	export var C2S_Order_OrderData: CmdType = createCmd("C2S_Order_OrderData", 52, 4, true, Pb_God.PBU32);
	/**确认订单地址  PBC2SOrderInfo*/
	export var C2S_Order_Completed: CmdType = createCmd("C2S_Order_Completed", 52, 5, true, Pb_God.PBC2SOrderInfo);
	/**设置默认参数 参数地址id  PBU32*/
	export var C2S_Order_SetDefault: CmdType = createCmd("C2S_Order_SetDefault", 52, 6, true, Pb_God.PBU32);
	/**删除地址	PBU32*/
	export var C2S_Order_DeleteAddr: CmdType = createCmd("C2S_Order_DeleteAddr", 52, 7, true, Pb_God.PBU32);
	/**获取最新订单信息 无内容*/
	export var C2S_Order_GetNewOrder: CmdType = createCmd("C2S_Order_GetNewOrder", 52, 8, true);
	...
	/**请求排行榜(精灵ID)  PBU32*/
	export var C2S_GodDeploy_TopList: CmdType = createCmd("C2S_GodDeploy_TopList", 53, 1, true, Pb_God.PBU32);
	/**点赞(精灵SN)	PBU64*/
	export var C2S_GodDeploy_Like: CmdType = createCmd("C2S_GodDeploy_Like", 53, 2, true, Pb_God.PBU64);
	/**失败才返回*/
	export var S2C_Order_Common_Ack: CmdType = createCmd("S2C_Order_Common_Ack", 54, 0, false);
	/**返回地址数据 PBAddrData*/
	export var S2C_Order_AddrData: CmdType = createCmd("S2C_Order_AddrData", 54, 1, false, Pb_God.PBAddrData);
	/**返回订单数据 PBOrderData*/
	export var S2C_Order_OrderData: CmdType = createCmd("S2C_Order_OrderData", 54, 2, false, Pb_God.PBOrderData);
	/**返回最新的订单信息 PBOrderInfo*/
	export var S2C_Order_OneNewOrder: CmdType = createCmd("S2C_Order_OneNewOrder", 54, 3, false, Pb_God.PBOrderInfo);
	/**失败才返回*/
	export var S2C_GodDeploy_Common_Ack: CmdType = createCmd("S2C_GodDeploy_Common_Ack", 55, 0, false);
	/**返回地址数据 PBGodDeployTopList*/
	export var S2C_GodDeploy_TopList: CmdType = createCmd("S2C_GodDeploy_TopList", 55, 1, false, Pb_God.PBGodDeployTopList);
	/**返回点赞数据 PBLikeInfo*/
	export var S2C_GodDeploy_LikeInfo: CmdType = createCmd("S2C_GodDeploy_LikeInfo", 55, 2, false, Pb_God.PBLikeInfo);
	/** 验证请求 	VerifyAsk*/
