...
module Pro
{
	export class FactionData_auto extends FactionDataMgrBase
	{
		constructor()
		{
			...
			EventMgr.on(Cmd.S2C_Faction_UpgradePVPSkill.cmdName, this, this.onUpgradePVPSkill)
			//	 PVP技能重置				PBG2CFactionPVPSkillReset
			EventMgr.on(Cmd.S2C_Faction_PVPSkillReset.cmdName, this, this.onPVPSkillReset)
		...
		/*****
		 *	 PVP技能升级				PBG2CFactionPVPSkillUpgrade
		 * @param PBG2CFactionPVPSkillUpgrade
		 * 		skillIndex			uint32	索引
		 * 		curlevel			uint32	当前等级
		 */
		protected onUpgradePVPSkill(value: Pb_God.PBG2CFactionPVPSkillUpgrade): void
		{
			
		}
		/*****
		 *	 PVP技能重置				PBG2CFactionPVPSkillReset
		 * @param PBG2CFactionPVPSkillReset
		 * 		jobtype			uint32	职业类型
		 * 		resetcount			uint32	重置次数
		 */
		protected onPVPSkillReset(value: Pb_God.PBG2CFactionPVPSkillReset): void
		{
