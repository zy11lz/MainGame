	...
	*/	
	...
	export class ConfigClassRegister 
	{
		...
		public static  TempleIdCountCfgInfo:string = "TempleIdCountCfgInfo";
		 /**   【cs_temple.xls】  ---> TempleSMonsterIndexCfgInfo    **/ 
		public static  TempleSMonsterIndexCfgInfo:string = "TempleSMonsterIndexCfgInfo";
		...
		public static  FactionImpeachTimeCfgInfo:string = "FactionImpeachTimeCfgInfo";
		 /**   【cs_faction.xls】  ---> FactionPvpSkillCfgInfo    **/ 
		public static  FactionPvpSkillCfgInfo:string = "FactionPvpSkillCfgInfo";
		 /**   【cs_faction.xls】  ---> FactionPvpSkillIndexCfgInfo    **/ 
		public static  FactionPvpSkillIndexCfgInfo:string = "FactionPvpSkillIndexCfgInfo";
		 /**   【cs_faction.xls】  ---> FactionPvpSkillUpgradeCfgInfo    **/ 
		public static  FactionPvpSkillUpgradeCfgInfo:string = "FactionPvpSkillUpgradeCfgInfo";
		 /**   【cs_faction.xls】  ---> FactionPvpSkillResetCfgInfo    **/ 
		public static  FactionPvpSkillResetCfgInfo:string = "FactionPvpSkillResetCfgInfo";
		...
		public static  TrainMonsterNewCfgInfo:string = "TrainMonsterNewCfgInfo";
		 /**   【c_login_windows.xls】  ---> LoginWindowsLoginWindowsCfgInfo    **/ 
		public static  LoginWindowsLoginWindowsCfgInfo:string = "LoginWindowsLoginWindowsCfgInfo";
		 /**   【c_gm.xls】  ---> GmCfgInfo    **/ 
		...
		public static  PetSkinCfgInfo:string = "PetSkinCfgInfo";
		 /**   【cs_pet_skin.xls】  ---> PetSkinSReplaceSkinCfgInfo    **/ 
		public static  PetSkinSReplaceSkinCfgInfo:string = "PetSkinSReplaceSkinCfgInfo";
		 /**   【cs_pet_skin.xls】  ---> PetSkinSReplaceEvolveCfgInfo    **/ 
		public static  PetSkinSReplaceEvolveCfgInfo:string = "PetSkinSReplaceEvolveCfgInfo";
		...
		public static  ActivityEggLuckyEggCfgInfo:string = "ActivityEggLuckyEggCfgInfo";
		 /**   【cs_activity_ant.xls】  ---> ActivityConstantConstantCfgInfo    **/ 
		public static  ActivityConstantConstantCfgInfo:string = "ActivityConstantConstantCfgInfo";
		...
		public static setup():void
		{
			...
			ConfigClassRegister.regClass("TempleSMonsterIndexCfgInfo", cfg.TempleSMonsterIndexCfgInfo);
			...
			ConfigClassRegister.regClass("FactionPvpSkillCfgInfo", cfg.FactionPvpSkillCfgInfo);
			ConfigClassRegister.regClass("FactionPvpSkillIndexCfgInfo", cfg.FactionPvpSkillIndexCfgInfo);
			ConfigClassRegister.regClass("FactionPvpSkillUpgradeCfgInfo", cfg.FactionPvpSkillUpgradeCfgInfo);
			ConfigClassRegister.regClass("FactionPvpSkillResetCfgInfo", cfg.FactionPvpSkillResetCfgInfo);
			...
			ConfigClassRegister.regClass("LoginWindowsLoginWindowsCfgInfo", cfg.LoginWindowsLoginWindowsCfgInfo);
			...
			ConfigClassRegister.regClass("PetSkinSReplaceSkinCfgInfo", cfg.PetSkinSReplaceSkinCfgInfo);
			ConfigClassRegister.regClass("PetSkinSReplaceEvolveCfgInfo", cfg.PetSkinSReplaceEvolveCfgInfo);
			...
			ConfigClassRegister.regClass("ActivityConstantConstantCfgInfo", cfg.ActivityConstantConstantCfgInfo);
